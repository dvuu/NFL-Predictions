...
module.exports = function(grunt) {
    ...
    grunt.config('concat', {
        ...
        jsCommon: {
            src: ['src/client/ext/js/jquery-1.12.3.min.js', 'src/client/ext/js/*.js', 'src/client/js/highchartsObj.js', 'src/client/js/chartObj.js', 'src/client/js/playInfoObj.js', 'src/client/js/topTenObj.js', 'src/client/js/fieldObj.js'],
